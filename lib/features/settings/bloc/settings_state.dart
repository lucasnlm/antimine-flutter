...
class SettingsState extends Equatable {
  ...
  bool get hasChanged => [
    ...
    settings?.tapToFlagNeighbours != GameSettings.initial.tapToFlagNeighbours,
  ...
  SettingsState copyWith({GameSettings? settings}) {
    return SettingsState(settings: settings ?? this.settings);
  }

  @override
  List<Object?> get props => [settings, hasChanged];
}
