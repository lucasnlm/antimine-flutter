                         ...
                         node234 **root, node234 *n, int ki)
{
    ...
    while (n)
    {
        ...
        if (n->parent)
            ki = (n->parent->kids[0] == n ? 0 : n->parent->kids[1] == n ? 1
                                            : n->parent->kids[2] == n   ? 2
                                                                        : 3);
        n = n->parent;
    }
    ...
    if (n)
    {
        while (n->parent)
        {
            ...
            int childnum;
            childnum = (n->parent->kids[0] == n ? 0 : n->parent->kids[1] == n ? 1
                                                  : n->parent->kids[2] == n   ? 2
                                                                              : 3);
...
static void trans234_subtree_left(node234 *n, int ki, int *k, int *index)
{
    ...
    i = (dest->elems[1] ? 2 : dest->elems[0] ? 1
                                             : 0);
...
static void trans234_subtree_merge(node234 *n, int ki, int *k, int *index)
{
    ...
    lsize = (left->elems[1] ? 2 : left->elems[0] ? 1
                                                 : 0);
    rsize = (right->elems[1] ? 2 : right->elems[0] ? 1
                                                   : 0);
